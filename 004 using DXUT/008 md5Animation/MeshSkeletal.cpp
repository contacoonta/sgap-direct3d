...
void MeshSkeletal::UpdateFrame(float deltaTime, int animationIdx)
{
	...
	*/
	...
	for (int k = 0; k < m_model.numSubsets; k++)
	{
		...
		{
			VERTEXSKELETAL tempVert = m_model.subsets[k].vertices[i];
...
Joint MeshSkeletal::LerpJoint(Joint& src, Joint& tar, float fdelta)
{
	Joint lerped;
